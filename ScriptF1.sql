...
grant select,insert,update,delete on ADMIN_ROLE.LOGIN to CUSTOMER_ROLE;
grant select,insert,update,delete on ADMIN_ROLE.TICKET to CUSTOMER_ROLE;
grant select,insert,update,delete on ADMIN_ROLE.SHOW_MOVIES to CUSTOMER_ROLE;
grant select,insert,update,delete on ADMIN_ROLE.ROOM_RESERVATION to CUSTOMER_ROLE;
grant select,insert,update,delete on ADMIN_ROLE.FOOD to CUSTOMER_ROLE;
grant select,insert,update,delete on ADMIN_ROLE.PAYMENT to CUSTOMER_ROLE;
grant select,insert,update,delete on ADMIN_ROLE.SHOP to CUSTOMER_ROLE;

grant select,insert,update,delete on ADMIN_ROLE.EMPLOYEE to EMPLOYEE_ROLE;
